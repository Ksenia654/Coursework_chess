...
const { getAllowedMoves } = require('./piece');
const { changePosition } = require('./piece'); 
...
class Game {
	...
	king_checked(color) {
		...
		for (const enemyPiece of enemyPieces) {
			if (!enemyPiece || !enemyPiece.position) {
				console.error('Некорректная фигура противника:', enemyPiece);
				continue;
			}
